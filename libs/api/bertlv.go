// cloned and  fixed from github.com/hexdigest/bertlv
...
// Class returns encoded class value - https://en.wikipedia.org/wiki/X.690#Encoding
func (tv TagValue) Class() int {
	if tv.T <= 0xff {
		return (tv.T&0xC0)>>6
	}

	return ((tv.T>>8)&0xC0)>>6
}
